...
function getEmbedDashboardUrl() {
  ...
  AWS.config.region = 'us-east-1'; // // initialize the Credentials object with our parameters
  ...
  AWS.config.credentials.get(function (err, data) {
    if (!err) {
      ...
      cognitoSyncClient.listDatasets({
        ...
        IdentityPoolId: "us-east-1:ff16daae-9dda-4e45-a95c-9fa8c5b939f7" // IdentityPoolId: "us-east-1:76b239eb-08cc-4712-ad0c-70eb09823cfa"
        ...
        if (!err) {
          ...
          var cognitoidentity = new AWS.CognitoIdentity(); //params.Logins['cognitoDeveloperProvidedName'] = 'Dhamodharan.Subramanian@harman.com'; 

          cognitoidentity.getOpenIdToken(params, function (err, data) {
            if (err) console.log(err, err.stack); // an error occurred
            else generateEmbedUrlForRegisteredUser('722436621188', '4ffc8fc5-2261-4d00-8b85-024d0399aa5c', data.Token, 'arn:aws:iam::722436621188:user/quicksigth_testuser', 'arn:aws:iam::722436621188:role/Cognito_jblwebportalUnauth_Role', temdata.params.RoleSessionName, getEmbedUrlCallback, errorCallback); // successful response
          });
        } else {
  ...
  function generateEmbedUrlForRegisteredUser(accountId, dashboardId, openIdToken, // Cognito-based token
  ...
  errorCallback // GetEmbedUrl error callback method
    ...
    stsClient.assumeRoleWithWebIdentity(stsParams, function (err, data) {
      if (err) {
        ...
        const quicksightGetDashboard = new QuickSight({
          region: 'us-east-1',
          credentials: {
          ...
          if (err) {
            ...
            const result = {
              ...
              "headers": {
                ...
                // Use your website domain to secure access to GetEmbedUrl API
